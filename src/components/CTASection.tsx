    ...
    <div className="relative">
      ...
      <section className="relative z-10 overflow-hidden rounded-[20px] border-1 border-white/5 px-5 py-9 sm:px-12 lg:px-20 lg:py-20">
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 lg:flex-row lg:items-center lg:gap-[150px]">
          ...
          <button
            type="button"
            className="w-full shrink-0 rounded-[12.5px] bg-sealed-teal px-[18.75px] py-[12.5px] font-lexend text-lg font-medium leading-[31.25px] text-black transition-all hover:scale-105 hover:shadow-lg hover:shadow-sealed-teal/20 lg:w-auto"
          >
            Sign up
          </button>
        </div>
