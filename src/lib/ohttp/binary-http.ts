 ...
 *
 * VENDORED z Sealed indexera (sealed-indexer/src/notifications/binary-http.ts),
 * który z kolei jest portem 1:1 z klienta Flutter
 * (sealed_app/lib/remote/ohttp/binary_http.dart). NIE ZMIENIAJ układu bajtów —
 * obie strony (gateway + ten klient) muszą się zgadzać co do bajtu, inaczej
 * gateway/relay zwróci 400. Aktualizuj tylko równolegle ze źródłem.
 *
