 ...
 *
 * VENDORED z Sealed indexera (sealed-indexer/src/notifications/ohttp-config.ts).
 * Zgodne z klientem Flutter (sealed_app/lib/remote/ohttp/ohttp_config.dart).
 * Bierze PIERWSZĄ ogłoszoną parę algorytmów symetrycznych.
 *
 * Wire format:
